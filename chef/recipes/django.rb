...
template "/home/#{user}/lfucg-exactions/lfucg-exactions/backend/server/settings/local.py" do
  source "/home/#{user}/lfucg-exactions/lfucg-exactions/backend/server/settings/local-dist.py"
  local true
  mode 0755
  variables( :config => config )
end

pip_requirements "/home/#{user}/lfucg-exactions/lfucg-exactions/backend/requirements.txt" do
...
bash "migrate" do
  ...
  cwd "/home/#{user}/lfucg-exactions/lfucg-exactions/backend"
end
