...
template "/home/ubuntu/lfucg-exactions/lfucg-exactions/backend/server/settings/local.py" do
  source "/home/ubuntu/lfucg-exactions/lfucg-exactions/backend/server/settings/local-dist.py"
  local true
  mode 0755
