        ...
        return (
            <div className="account-form">
                ...
                <div className="inside-body">
                    <div className="container">
                        {accounts.errorAccount ? <ErrorScreen error={accounts.errorAccount} /> : null}
    ...
    return {
        ...
        onSubmit(event) {
            ...
            if (selectedAccount) {
                ...
                .then((data) => {
                    if (data.error) {
                        dispatch(setAccountError({message: data.message}));   
                    }
                    if (data.response) {
                ...
                .then((data_post) => {
                    if (data_post.error) {
                        dispatch(setAccountError({message: data_post.message}));   
                    }
