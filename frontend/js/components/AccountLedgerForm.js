...
class AccountLedgerForm extends React.Component {
    ...
    render() {
        ...
        const sewerEqual = Number(activeForm.sewer_credits) == (Number(activeForm.sewer_cap) + Number(activeForm.sewer_trans)).toFixed(2);
        const nonSewerEqual = Number(activeForm.non_sewer_credits) == (Number(activeForm.parks) + Number(activeForm.storm) + Number(activeForm.roads) + Number(activeForm.open_space)).toFixed(2);
