                                        ...
                                        <div className="row">
                                            <div className="col-sm-6 form-group">
                                                ...
                                                <select
                                                    ...
                                                    id="account_id"
                                                    onChange={formChange('account_id')}
                                                    value={activeForm.account_id_show || 'start_account'}
                                                    aria-required="true"
                                                >
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-6 form-group">
                                                ...
                                                <select
                                                    ...
                                                    value={activeForm.expansion_area_show || 'start_area'}
                                                    aria-required="true"
                                                >
                                        ...
                                        <div className="row">
                                            <div className="col-sm-6 form-group">
                                                ...
                                                <select
                                                    className="form-control"
                                                    id="agreement_type"
                                                    onChange={formChange('agreement_type')}
                                                    value={activeForm.agreement_type_show || 'start_type'}
                                                    aria-required="true"
                                                >
