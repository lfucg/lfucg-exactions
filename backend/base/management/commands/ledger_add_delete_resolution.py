...
class Command(BaseCommand):
    ...
    def GetLedgerLot(self, address):
      ...
      address_full__icontains=address
        ...
        return return_lot.first() if return_lot is not None else None
    ...
    def GetLedgerPlat(self, plat):
      ...
      cabinet=cabinet, slide=slide
        ...
        return plat_obj.first() if plat_obj is not None else None
    ...
    def GetLedgerAgreement(self, agree_string, plat):
        ...
        return return_agreement.first() if return_agreement is not None else None
    ...
    def AddNewLedgers(self, df):
        ...
        for index, row in df.iterrows():
            ...
            account = plat.account if plat is not None else None
