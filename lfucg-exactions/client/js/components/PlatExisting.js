                        ...
                        {(currentUser.id || plat.is_approved) && <div>
                            ...
                            <div className="row">
                                <div className="col-sm-offset-1">
                                    <p className="col-sm-4 col-xs-6">Sewer Remaining: {plat.plat_exactions && plat.plat_exactions.plat_sewer_due}</p>
                                    <p className="col-sm-4 col-xs-6">Non-Sewer Remaining: {plat.plat_exactions && plat.plat_exactions.plat_non_sewer_due}</p>
