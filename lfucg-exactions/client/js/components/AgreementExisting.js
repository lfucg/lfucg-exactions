                        ...
                        {(currentUser.id || agreement.is_approved) && <div>
                            ...
                            <div className="row">
                                <div className="col-sm-offset-1">
                                    <p className="col-md-4 col-xs-6">Current Balance: {agreement.agreement_balance && agreement.agreement_balance.total.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}</p>
