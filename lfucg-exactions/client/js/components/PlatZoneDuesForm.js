...
PlatZoneDuesForm.propTypes = {
    ...
    dues_roads_value: PropTypes.string,
    dues_open_spaces_id: PropTypes.string,
    dues_open_spaces_value: PropTypes.string,
    dues_sewer_cap_id: PropTypes.string,
    dues_sewer_cap_value: PropTypes.string,
    dues_sewer_trans_id: PropTypes.string,
    dues_sewer_trans_value: PropTypes.string,
    dues_parks_id: PropTypes.string,
    dues_parks_value: PropTypes.string,
    dues_storm_water_id: PropTypes.string,
    dues_storm_water_value: PropTypes.string,
