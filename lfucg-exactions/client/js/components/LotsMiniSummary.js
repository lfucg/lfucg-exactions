                    ...
                    <div className="col-xs-12 col-sm-5 col-sm-offset-7">
                        <div className="col-xs-5">
                            {currentUser && currentUser.permissions && currentUser.permissions.lot &&
                                <Link to={`lot/form/${this.props.mapSet.id}`} aria-label={`Edit ${this.props.mapSet.id}`}>
                        ...
                        <div className="col-xs-5 ">
                            <Link to={`lot/summary/${this.props.mapSet.id}`} aria-label={`${this.props.mapSet.id} Summary`}>
